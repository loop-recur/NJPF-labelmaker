...
var f_g_x_h_x = defn(function(f, g, h, x) { return f(g(x), h(x)); });
...
return {f_g_h : f_g_h, f_g_h_x : f_g_h_x, f_g_x_h_x: f_g_x_h_x, f_g_x_h : f_g_x_h, f_g_x_y: f_g_x_y, f_x_h_g_x: f_x_h_g_x}
